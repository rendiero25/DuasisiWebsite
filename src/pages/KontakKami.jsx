        ...
        <div className="flex flex-col justify-between items-center">
            ...
            <div className="flex flex-col justify-between items-center w-full">
                <div className="px-6 xl:px-20 3xl:px-60 py-10 3xl:py-25 flex flex-col w-full xl:flex-row justify-between items-start gap-10 xl:gap-25">
                    <div className="flex flex-col justify-between items-center xl:items-start gap-4 xl:max-w-lg h-full">
                    ...
                    <div className="w-full max-w-5xl">
                        <form onSubmit={handleSubmit} className="p-8">
                            ...
                            <div className="text-center">
                                <button
                                    type="submit"
                                    className="bg-primary hover:bg-primary/90 text-white font-semibold py-3 px-8 rounded-lg transition-colors duration-300 focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 "
                                >
                                    Kirim Pesan
                                </button>
                            </div>
