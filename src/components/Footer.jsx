...
const Footer = () => {
    return(
        <div className="bg-black px-6 xl:px-20 pt-10 pb-6">
            <div className="flex flex-col justify-between items-center gap-6 py-5">
                <div className="flex flex-col xl:flex-row justify-between items-center gap-10">
                    <div className="flex flex-col justify-between items-start gap-6">
                        <h2 className="text-white font-medium text-3xl xl:text-6xl text-center xl:text-left">Outsourcing atau jasa penyaluran tenaga kerja</h2>
                        <ul className="flex flex-wrap xl:flex-row justify-center xl:justify-start items-center gap-4 text-white font-reguler text-sm">
                            <li>Beranda</li>
                    ...
                    <div className="flex flex-col justify-between items-center xl:items-end gap-4">
                        ...
                        <p className="font-reguler text-white text-sm leading-normal text-center xl:text-right">Jl. Lapangan Bola No. 9C, RT.03, RW.10 <br/>
                ...
                <div className="flex flex-col xl:flex-row justify-between items-center gap-4">
                    ...
                    <p className="text-white text-sm font-reguler text-center xl:text-right">
                        Copyright C 2025 PT. Dua Sisi Sejahtera. All rights reserved. Developed by
                            <span>
                                <a href="https://www.rendiero.dev" className="text-white font-semibold text-sm">Rendiero</a>
                            </span>
                    </p>
                </div>
            </div>
